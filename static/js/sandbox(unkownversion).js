...
(function(){
	...
	var factory = function($, Kinetic){
		return function(container, width, height, config) {
			...
			this.bind = function(){
				//get all names of methods in group
				//bind to element with same name for this.selectedGroup
				//onclick = this.selectedgroup.function with variables? how do i do this
			}


			//checks to see if a group is clicked on rendered canvas
			...
			//returns a random position within the stage
			...
			//adds a new group under the current group
			...
			//adds a new group to the parent of current group
			...
			//decides whether to add subgroup or sibling group
