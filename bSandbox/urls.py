...
urlpatterns = patterns('',
    ...
    url(r'^brandCheck/', include('brandCheck.urls')),
    url(r'^datasiftSandBox/', include('datasiftSandBox.urls')),
    url(r'^fbCanvas/', include('fbCanvas.urls')),
    url(r'^hootsuite/', include('hootsuite.urls')),
